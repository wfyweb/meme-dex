...
export class CreateRankSwapDto {
  @ApiProperty({
    description:
      '查询排序的字段：open_timestamp：时间 liquidity：池子 marketcap：市值 holder_count 持有者 swaps 交易数 volume 成交额 price：价格 change1m: 1m涨跌幅 change5m: 5m涨跌幅 change1h:1h涨跌幅',
    required: false,
    example: 'liquidity',
  })
  @IsOptional()
  ...
  @ApiProperty({
    description:
      '安全监测,Dev 多选查询字段： burn:烧池子 distribed: Top10 frozen: 黑名单 renounced： Mint丢弃 ，creator_hold:DEV 未清仓 creator_close:DEV 清仓 token_burnt：DEV 烧币',
    required: false,
